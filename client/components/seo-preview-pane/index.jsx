	...
	return (
		<ReaderPreview
			...
			postExcerpt={ formatExcerpt(
				get( post, 'excerpt', false ) || get( post, 'content', false ),
			) }
...
const GoogleSite = site => (
	<SearchPreview title={ site.name } url={ site.URL } snippet={ getSeoExcerptForSite( site ) } />
);
...
export class SeoPreviewPane extends PureComponent {
	...
	render() {
		const { post, site, translate, showNudge } = this.props;
