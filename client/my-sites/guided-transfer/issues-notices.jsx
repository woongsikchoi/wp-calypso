...
const mapStateToProps = ( state, ownProps ) => ( {
	premiumThemeIssue: getGuidedTransferIssue(
		state,
		ownProps.siteId,
		{ reason: 'premium-theme', prevents_transfer: false },
	),
	customFontIssue: getGuidedTransferIssue(
		state,
		ownProps.siteId,
		{ reason: 'custom-font', prevents_transfer: false },
	),
} );
